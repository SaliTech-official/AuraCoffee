...
export default function Header() {
  return (
    <div className='w-full h-[100px] bg-brown text-cream flex items-center justify-between px-8 md:px-12 lg:px-[70px] overflow-hidden shadow-[0_4px_20px_rgba(0,0,0,0.15)]'>
        ...
        <h1 className='min-w-[120px] md:min-w-[140px] lg:min-w-[200px] text-xl md:text-2xl lg:text-3xl font-bold font-heading text-center whitespace-nowrap'>Menu</h1>
    </div>
  )
}
